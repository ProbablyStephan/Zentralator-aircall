...
class MainPanel(wx.Panel):
    ...
    #Funtctions
    def OnCheck(self, e):
        self.logger.AppendText(datetime.now().strftime("%H:%M:%S") +" - "+ teamFun.teamCheck()+"\n")
        return
    
    def OnIn(self, e):
        self.logger.AppendText(datetime.now().strftime("%H:%M:%S") +" - "+ teamFun.teamPost()+"\n")
        return
    
    def OnOut(self, e):
        self.logger.AppendText(datetime.now().strftime("%H:%M:%S") +" - "+ teamFun.guardedDelete()+"\n")
        return
